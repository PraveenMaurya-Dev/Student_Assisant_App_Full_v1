...
public class Semester_6_Sub extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_semester_6__sub);
        setupUIViews();
        initToolbar();
        setupListView();
    }
    ...
    private void initToolbar(){
        ...
        getSupportActionBar().setTitle("TYIT Semester VI");
    ...
    public class SubjectAdapter extends ArrayAdapter {
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            Semester_6_Sub.SubjectAdapter.ViewHolder holder;
            if(convertView == null){
                ...
                holder = (Semester_6_Sub.SubjectAdapter.ViewHolder)convertView.getTag();
            }
